...
class Discriminator(nn.Module):
    def __init__(self, **kwargs):
        ...
        # In the supplementary materials, they describe the sigmoid as a softmax, but that doesn't seem to make sense
    ...
    def forward(self, img, txt=None):
        ...
        if txt is None:
            # unconditional wants a 4-dimensional weight 1 512 4 4, which means it wants only one image instead of a
            # batch of 64
        ...
        LD_results_by_conv = []
        for j in range(3):
            # input to this section: txt-# words x 300, img from conv3, conv4, or conv5
            # output: tensor with "score" for each word in sentence of whether or not it appears in image
